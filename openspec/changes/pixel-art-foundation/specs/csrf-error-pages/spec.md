...
(Previously: Error pages referenced individual CSS files; now all pages including 403 use the single consolidated `styles.css`.)
...
(Previously: 403 view had no design system specification; now it must conform to the pixel art identity.)

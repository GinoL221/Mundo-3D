...
(Previously: Every desktop page used one centered 1440px maximum from 1024px for main content, footer, and navigation.)
...
(Previously: Required all mobile and tablet layouts, including Home, to remain exactly unchanged below 1024px.)

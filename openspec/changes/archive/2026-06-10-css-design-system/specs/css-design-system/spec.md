...
- AND all semantic custom properties (`--bg`, `--fg`, `--accent`, `--danger`, `--warning`, `--surface`) MUST resolve to PICO-8 hex values in dark mode

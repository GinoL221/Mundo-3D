...
The navigation bar MUST include a toggle control that enables or disables the CRT filter and JRPG cursors. The user's preference MUST persist in `localStorage` and be applied during page initialization to avoid a flash of unstyled content.

...
## Purpose
Restricts access to administrative web routes (such as product creation, editing, deletion, and user deletion) and User API routes to users with administrator privileges (`IDRole === 1` or role `'Admin'`).
